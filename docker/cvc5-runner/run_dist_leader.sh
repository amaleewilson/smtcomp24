...
echo "{  \"formula_file\": \"$DOCKER_FORMULA_FILE\",  \"worker_node_ips\": [\"leader\", \"worker\"],  \"timeout_seconds\": \"1000\",  \"formula_language\": \"\",  \"solver_argument_list\": [$SOLVER_ARGS] }" > "$HOST_RUNDIR/input.json"
